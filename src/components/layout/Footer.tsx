...
const quickLinks = [
  ...
  { label: "Ambassador Portal", href: "/ambassador" },
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-6">
              <Link
                href="/contact"
                className="inline-flex items-center rounded bg-gold px-5 py-2.5 text-sm font-semibold text-midnight transition-colors hover:bg-gold-deep"
              >
